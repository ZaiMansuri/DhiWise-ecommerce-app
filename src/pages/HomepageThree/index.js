  ...
  return (
    <>
      <Column className="bg-white_A700 font-interui items-center mx-[auto] w-[100%]">
        ...
        <Row className="items-center lg:mt-[31px] xl:mt-[35px] mt-[40px] 3xl:mt-[48px] w-[87%]">
          <Column className="lg:mb-[31px] xl:mb-[35px] mb-[40px] 3xl:mb-[48px] lg:pr-[23px] xl:pr-[26px] pr-[30px] 3xl:pr-[36px] w-[34%]">
            <div className="bg-gray_401 lg:h-[397px] xl:h-[454px] h-[510px] 2xl:h-[511px] 3xl:h-[613px] rounded-radius10 w-[100%]"></div>
            <div className="bg-gray_401 lg:h-[397px] xl:h-[454px] h-[510px] 2xl:h-[511px] 3xl:h-[613px] lg:mt-[46px] xl:mt-[53px] mt-[60px] 3xl:mt-[72px] rounded-radius10 w-[100%]"></div>
            <div className="bg-gray_401 lg:h-[397px] xl:h-[454px] h-[510px] 2xl:h-[511px] 3xl:h-[613px] lg:mt-[46px] xl:mt-[53px] mt-[60px] 3xl:mt-[72px] rounded-radius10 w-[100%]"></div>
            <div className="bg-gray_401 lg:h-[397px] xl:h-[454px] h-[510px] 2xl:h-[511px] 3xl:h-[613px] lg:mt-[46px] xl:mt-[53px] mt-[60px] 3xl:mt-[72px] rounded-radius10 w-[100%]"></div>
          </Column>
          <Column className="lg:pr-[23px] xl:pr-[26px] pr-[30px] 3xl:pr-[36px] w-[34%]">
            <div className="bg-gray_401 lg:h-[471px] xl:h-[539px] h-[605px] 2xl:h-[606px] 3xl:h-[727px] rounded-radius10 w-[100%]"></div>
            <div className="bg-gray_401 lg:h-[471px] xl:h-[539px] h-[605px] 2xl:h-[606px] 3xl:h-[727px] lg:mt-[46px] xl:mt-[53px] mt-[60px] 3xl:mt-[72px] rounded-radius10 w-[100%]"></div>
            <div className="bg-gray_401 lg:h-[471px] xl:h-[539px] h-[605px] 2xl:h-[606px] 3xl:h-[727px] lg:mt-[46px] xl:mt-[53px] mt-[60px] 3xl:mt-[72px] rounded-radius10 w-[100%]"></div>
            <Button
              className="font-bold ml-[107px] 3xl:ml-[128px] lg:ml-[83px] xl:ml-[95px] lg:mt-[175px] xl:mt-[200px] mt-[225px] 3xl:mt-[270px] xl:text-[10px] text-[12px] 3xl:text-[14px] lg:text-[9px] text-center tracking-ls1 w-[46%]"
              variant="FillGray401"
            >
              LOAD MORE
            </Button>
        ...
        <Column className="bg-gray_202 lg:mt-[62px] xl:mt-[71px] mt-[80px] 3xl:mt-[96px] lg:p-[49px] xl:p-[56px] p-[64px] 3xl:p-[76px] w-[100%]">
